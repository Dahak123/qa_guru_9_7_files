...
public class FilesTest {
    ...
    void filenameShouldDisplayedAfterUploadActionTest() {
        Selenide.open("https://wdfiles.ru/");
        File exapmleFile = new File("C:/Users/Рустам/IdeaProjects/qa_guru_9_7_files/src/test/resources/example.txt");
        $("input[type='file']").uploadFile(exapmleFile);
        $("#initialUploadSection").click();
        $("#uploadButton").shouldHave(text("example.txt"));
